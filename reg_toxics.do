    ...
    foreach chem in $CHEMS {
        ...
        * If file already exists, do nothing
        ...
        if "`chem'" == "nox" {
            ...
            egen aermod_`chem'_pre_3 = rowmean(aermod_`chem'_1998* aermod_`chem'_1999* aermod_`chem'_2000*)
            egen aermod_`chem'_pre_5 = rowmean(aermod_`chem'_1996* aermod_`chem'_1997* aermod_`chem'_1998* aermod_`chem'_1999* aermod_`chem'_2000*)
        }
        else {
            egen aermod_`chem'_pre_1 = rowmean(aermod_`chem'_2000)
        ...
        egen aermod_`chem'_post_3 = rowmean(aermod_`chem'_2001* aermod_`chem'_2002* aermod_`chem'_2003*)
        egen aermod_`chem'_post_5 = rowmean(aermod_`chem'_2001* aermod_`chem'_2002* aermod_`chem'_2003* aermod_`chem'_2004* aermod_`chem'_2005*)
