...
prog def main_reg
    ...
    * Create AERMOD variables based on timespan
    ...
    foreach diag in $outcomes {
        ...
        gen aermod_pre_d_`diag' = aermod_pre * tmp_diag_within_limit
        gen aermod_diff_d_`diag' = aermod_diff * tmp_diag_within_limit
...
global outcomes /// Health outcomes to examine
    ...
    stroke_tia_ever cancer_any_ever asthma_ever
    // majordepression_ever migraine_ever hypert anxiety cancer_lung_ever  
local timespans 1 3 5 10  // Time horizon for outcomes (e.g., 3-year mortality)

* Basic Specification
global OUT_NAME "regs_interact_diag"
global X aermod_diff aermod_diff_d* aermod_pre aermod_pre_d*        // X's of interest
